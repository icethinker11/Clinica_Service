...
export default function PanelPrincipal({ username, users = [], roles = [], opciones = [], setActivePage }) {
  ...
  const [opcionCount, setOpcionCount] = useState(0);

  // Actualizar contadores cuando cambien las props
  useEffect(() => {
    setUserCount(users.length);
    setRoleCount(roles.length);
    setOpcionCount(opciones.length);
  }, [users, roles, opciones]);
    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 mt-4">
        ...
        <div className="bg-white p-6 rounded-2xl shadow flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-2xl">{roleCount}</p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-2xl">{opcionCount}</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div
          ...
          className="bg-blue-100 hover:bg-blue-200 p-6 rounded-xl shadow cursor-pointer text-center transition"
        >
        ...
        <div
          ...
          className="bg-green-100 hover:bg-green-200 p-6 rounded-xl shadow cursor-pointer text-center transition"
        >
        ...
        <div
          ...
          className="bg-purple-100 hover:bg-purple-200 p-6 rounded-xl shadow cursor-pointer text-center transition"
        >
